...
public class ADFUtils {
    ...
    public static JUCtrlListBinding findCtrlListBinding(String name){
        JUCtrlListBinding rowBinding = 
            (JUCtrlListBinding)getDCBindingContainer().findCtrlBinding(name);    
        if (rowBinding == null) {
            throw new RuntimeException("CtrlListBinding " + name + "' not found");
        }
        return rowBinding;
    }
    ...
    public static String printUserRoles() {
        if (isAuthenticated()) {
